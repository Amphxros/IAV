...
namespace UCM.IAV.Navegacion
{
    ...
    public class GraphGrid : Graph
    {
        ...
        public Vector3 getSalida() { return salida; }

        public int getCol() { return numCols; }
        public int getRow() { return numRows; }

        public GameObject getVertexById(int id) { return vertexObjs[id]; }
